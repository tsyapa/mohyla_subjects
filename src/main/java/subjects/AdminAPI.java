...
public class AdminAPI {
	...
	public Message addFaculty(@Named("token")String token, @Named("name")String name){
	...
	public Message removeFaculty(@Named("token")String token, @Named("name")String name){
	...
	public Message addDepartment(@Named("token")String token, @Named("name")String name, @Named("faculty_name")String faculty_name){
	...
	public Message removeDepartment(@Named("token")String token, @Named("name")String name){
	...
	public Message addSubject(@Named("token")String token, @Named("name")String name,@Named("faculty_name") String faculty_name, @Named("lector")String lector,@Named("credits") double credits, @Named("trimester")int trimester,@Named("description") String description,@Named("department_id") long department_id){
	...
	public Message removeSubject(@Named("token")String token, @Named("name")long id){
	...
	public Message addSpeciality(@Named("token")String token, @Named("name")String name, @Named("faculty_name")String faculty_name){
	...
	public Message removeSpeciality(@Named("token")String token, @Named("name")String name){
	...
	public Message setProfessional(@Named("token")String token,  @Named("speciality_name")String speciality_name ,@Named("subject_id")long subject_id, @Named("value")boolean value){
